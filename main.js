...
// 	sqlUtils.insert('items', 'name, type, stackSize', '\'test\', \'buildingPart\', 1');
// });


// sqlUtils.createTable('mapItems', 'id INTEGER primary key autoincrement, type TEXT, size INTEGER', function(){
